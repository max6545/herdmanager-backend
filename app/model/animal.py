...
class Animal(WatermelonModel):
    ...
    ear_tag = db.Column(db.String(255), nullable=False)
    ...
    farm_code = db.Column(db.String(255), nullable=False)
    description = db.Column(db.Text(), nullable=False)
    rejected_at = db.Column(db.DateTime)
    rejected_reason = db.Column(db.Text(), nullable=False)
    rejected_info = db.Column(db.Text(), nullable=False)
